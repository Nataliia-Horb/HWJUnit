...
//     2*. Имеется класс RandomizedQueue.
//        Это тип очереди, из которой данные извлекаются в случайном порядке.
//        Логику работы RandomizedQueue можно посмотреть в методе main() класса.
//        Написать unit-тесты для проверки работы публичных методов RandomizedQueue:
